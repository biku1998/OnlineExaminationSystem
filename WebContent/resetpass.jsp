...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">*  Student Passwword Reset portal *</h1>
                </div>
            </div>

            <!-- ... Your content goes here ... -->
            
             <form action="resetpassup.jsp" method="post">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="passwordc" class="form-control" required="required">
                </div>
                
                
                <input type="submit" name="submit"  value="Change" class="btn btn-block btn-success"style="width:25%;">
