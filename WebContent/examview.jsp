...
ArrayList<question> ques = (ArrayList<question>) session.getAttribute("qlist");
...
String opn1=q.getInans1();
String opn2=q.getIncans2();
String opn3=q.getIncans3();
String opn4=q.getIncans4();
String correct = q.getAnswer();
String topic = (String)session.getAttribute("topicex");
	...
	<%
 	...
 	%>
			  ...
			  <label class="radio inline"> 
			      <input type="radio" name="opn" value=<%=opn1 %> >
			      1.<span>   <%=opn1 %> </span> 
			   </label></th></tr>
			   <tr><th>
			  <label class="radio inline"> 
			      <input type="radio" name="opn" value=<%=opn2 %>>
			      2.<span> <%=opn2 %> </span> 
			  </label></th></tr>
			    <tr><th>
			  <label class="radio inline"> 
			      <input type="radio" name="opn" value=<%=opn3 %>>
			      3.<span><%=opn3 %></span> 
			  </label></th></tr>
			    <tr><th>
			  <label class="radio inline"> 
			      <input type="radio" name="opn" value=<%=opn4 %>>
			      4.<span><%=opn4 %> </span> 
